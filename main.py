...
def main(): 
    ...
    if st.session_state.script_choice == "about":
        ...
        st.markdown("""
        <h5 style="color:red;">📅 Schedule Generator</h5>
        ...
        st.markdown("""
        <h5 style="color:red;">📄 Polygon Parser</h5>
        ...
        st.markdown("""
        <h5 style="color:red;">📄 INP Parser</h5>
        ...
        st.markdown("""
        <h5 style="color:red;">📄 Purging INP</h5>
        ...
        st.markdown("""
        <h5 style="color:red;">📄 SIM Parser</h5>
        ...
        """, unsafe_allow_html=True)
        st.markdown("""
        <h6 style="color:red;">Latest Update</h6>
        <p style="font-size:14px; color:#888; font-style:italic; margin-top:-6px; margin-bottom:10px;">
        <b>24th Feb, 2025: </b>New Reports Added (LS-A, LS-B, LS-C Losses, LV-H)</p>""", unsafe_allow_html=True)
        ...
        st.markdown("""
        <h5 style="color:red;">🔍 Quality Check / Quality Assurance</h5>
        ...
        """, unsafe_allow_html=True)
        st.markdown("""<b>Please Note:</b> It can accept multiple sim files.""", unsafe_allow_html=True)
        st.markdown("""
        <h6 style="color:red;">Latest Update</h6>
        <p style="font-size:14px; color:#888; font-style:italic; margin-top:-6px; margin-bottom:10px;">
